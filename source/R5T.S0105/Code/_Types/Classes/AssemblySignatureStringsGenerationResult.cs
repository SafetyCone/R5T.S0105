...
{
    /// <summary>
    /// For use in validating signature string generation - from member info to signature string, to signature, to identity string from signature (validated against member info to identity string).
    /// </summary>
    public class AssemblySignatureStringsGenerationResult
    {
        ...
        public List<SignatureStringIdentityFailurePair> Failures { get; } = new();
